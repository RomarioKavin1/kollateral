...
- **Next.js 16** (App Router) — note: this project pins a pre-release/breaking-change build of Next.js; see [Development notes](#development-notes) before editing framework-adjacent code.
- **TypeScript**, **React 19**
- **better-sqlite3** — embedded SQLite datastore (`lib/db.ts`, `lib/schema.sql`)
...
| Variable | Purpose |
|---|---|
| `DB_PATH` | Path to the SQLite database file (defaults to `./kollateral.db`) |
